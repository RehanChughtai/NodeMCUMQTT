--please note that this code has a pitfall in it
--though it could be executed
--please identify the pitfall and let me know how your plan to solve it
--Dalin
pinPWM=3
freq=1000
dc=1023
...
function pubPWM(client)
    ...
    client:publish(PUBLISH_TOPIC,tostring(dc),1,0,function(client)
    print("Duty cycle sent: ",dc)
        end)
    end)
...
mytimerPWM:register(1,tmr.ALARM_AUTO,function()
    changingPWM()
end
)
mytimerPWM:start()
